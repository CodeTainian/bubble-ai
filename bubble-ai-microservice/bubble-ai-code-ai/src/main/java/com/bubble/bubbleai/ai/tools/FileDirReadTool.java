...
/**
 * 文件读取工具，支持Ai通过工具调用的方式读取文件
 * A file-reading tool that enables AI to read files via tool invocation
 */
@Slf4j
@Component
public class FileDirReadTool extends BaseTool {
    ...
    @Tool("读取目录结构，获取制定目录下的所有文件和子目录信息")
    ...
    public String generateToolExecutedResult(JSONObject argument) {
        String relativeDirPath = argument.getStr("relativeDirPath");
