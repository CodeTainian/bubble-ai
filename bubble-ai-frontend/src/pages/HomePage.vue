...
const suggestions = [
  {
    title: '企业官网 · HTML',
    prompt: '请使用原生 HTML 模式生成一个单文件科技服务公司官网，只输出一个 index.html，CSS 和 JavaScript 都内联在同一个文件中；页面包含首页首屏、服务介绍、核心优势、客户案例、团队介绍和联系表单，整体风格简洁专业，蓝白配色，适合展示 AI 软件定制与数字化转型能力。',
  },
  {
    title: '产品落地页 · 多文件',
    prompt: '请使用原生多文件模式生成一个 SaaS 产品落地页，用于推广团队协作工具；请将结构、样式和交互分别拆分为 index.html、style.css、script.js 三个文件，页面包含产品价值主张、功能亮点、使用流程、价格套餐、用户评价和立即试用按钮，整体风格现代、有科技感。',
  },
  {
    title: '作品集 · React',
    prompt: '请使用 React 工程模式生成一个前端开发者个人作品集项目，基于 React + Vite 实现组件化页面；需要包含首页、项目列表、项目详情、关于我和联系页面，支持项目分类筛选、详情弹层或路由跳转、响应式导航，整体设计清爽高级，突出专业能力和项目成果。',
  },
  {
    title: '门店展示页 · 多文件',
    prompt: '请使用原生多文件模式生成一个咖啡店品牌展示网站，将页面结构、样式和交互拆分为 index.html、style.css、script.js；内容包含品牌故事、门店环境、招牌饮品、菜单价格、营业时间、地图位置和预约联系入口，视觉风格温暖但不花哨，适合移动端浏览。',
  },
]
