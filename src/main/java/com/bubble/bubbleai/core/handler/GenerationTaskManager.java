...
public class GenerationTaskManager {
    ...
    /**
     * Atomically creates a task and only invokes the source supplier for the
     * winning request. Concurrent clicks join the existing task without saving
     * another user message or starting another model/file-writing stream.
     */
